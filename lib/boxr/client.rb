module Boxr
  ...
  class Client
    ...
    def get(uri, query: nil, success_codes: [200], process_response: true, if_match: nil, box_api_header: nil, follow_redirect: true, optional_headers: nil)
      ...
      res = with_auto_token_refresh do
        ...
        headers = headers.merge(optional_headers) unless optional_headers.nil?
