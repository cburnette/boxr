...
describe 'task operations' do
  it 'invokes task operations' do
    ...
    expect do
      box_client_as_test_user = Boxr::Client.new(ENV['BOX_DEVELOPER_TOKEN'],
                                                 as_user_id: @test_user.id)
      task_assignment = box_client_as_test_user.update_task_assignment(TEST_TASK,
